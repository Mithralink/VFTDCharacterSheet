...
class Rogue(Character):
    def __init__(self, name: str, ability_scores : int, level : int, character_race : str, character_class : str, hit_points: int, mods, sanity, grit, prof, hit_dice, spirit_bond=None):
        ...
        print(f"{self.name}, You're a level {self.level} {self.character_race} Rogue!")
    ...
    def get_summary(self):
        return (
            f"{self.name}, You're a level {self.level} {self.character_race} Rogue!\n"
...
man = Rogue("Rogue", [10, 10, 10, 10, 10, 10], 2, "shaelarae", "Rogue", "", [0, 0, 0, 0, 0, 0], 0, 0, 2, "", "")